...
class PLUGIN_CLASS_NAME_BASE_Manager {
    ...
    private function load_dependencies() {
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-add-to-your-favourites-posts-manager-admin.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-add-to-your-favourites-posts-manager-options.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-add-to-your-favourites-posts-manager-public.php';

        require_once plugin_dir_path( __FILE__ ) . 'class-add-to-your-favourites-posts-loader.php';
